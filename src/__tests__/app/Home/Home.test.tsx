...
const routes: RouteObject[] = [
    {
        ...
        element: <Home />,
        loader: () => ({
            moviesHighlightsToo: Promise.resolve({ results: [] }),
            movieHightlightDetail: Promise.resolve({ results: [] }),
            moviesLatestReleases: Promise.resolve({ results: [] }),
            moviesRecommended: Promise.resolve({ results: [] }),
